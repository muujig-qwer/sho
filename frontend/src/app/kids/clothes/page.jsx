...
export default function KidsClothesPage() {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:5000/api/products/category/id/ТА_ХҮҮХДИЙН_ХУВЦАС_АНГИЛЛЫН_ID') // ← энд хүүхдийн хувцас ангиллын ID-г оруулна уу
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Хүүхэд – Хувцас</h1>
