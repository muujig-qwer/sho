...
export default function TravelPage() {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:5000/api/products/category/id/ТА_АЯЛАЛ_АНГИЛЛЫН_ID') // ← энд аялал ангиллын ID-г оруулна уу
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Аялал</h1>

      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Зүүн Sidebar */}
        <aside className="md:col-span-1">
          <nav className="space-y-6">
            {othersSubcategories.map((section, idx) => (
              <div key={idx}>
