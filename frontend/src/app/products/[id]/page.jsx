...
export default function ProductDetailPage() {
  ...
  const handleSubmitComment = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`http://localhost:5000/api/products/${id}/comments`, commentData)
          ...
          <div className="md:w-1/2 w-full">
            ...
            <div className="space-y-10">
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-1 mt-2">
                    {[1, 2, 3, 4, 5].map((star) => (
                      <span
                        key={star}
                        className={`text-xl ${avgRating >= star ? 'text-yellow-400' : 'text-gray-300'}`}
                      >
                        ★
                      </span>
                    ))}
                      ...
                      return (
                        <button
                          ...
                          className={`py-3 px-4 border rounded-lg text-center font-medium transition-all
                            ${selectedSize === size && isAvailable ? 'border-gray-900 bg-gray-900 text-white' : ''}
                            ${!isAvailable ? 'border-gray-200 text-gray-400 line-through cursor-not-allowed bg-gray-100' : 'border-gray-200 hover:border-gray-400 text-gray-900'}
                          `}
                        >
                          {size}
                        </button>
              ...
              <div className="space-y-3">
                ...
                <button className="w-full border border-gray-300 text-gray-900 py-4 rounded-full font-semibold text-lg hover:border-blue-400 transition">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
              ...
              <div className="flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-gray-200 py-8 w-full">
                ...
                <div className="mt-4 text-center">
                  <h3 className="font-bold text-gray-900 text-lg mb-2">ҮНЭГҮЙ ХҮРГЭЛТ</h3>
                  <p className="text-gray-600 text-sm">100,000₮-аас дээш захиалгад</p>
                </div>
              </div>
              {/* 2-р perk */}
              <div className="flex flex-col items-center justify-center border-b md:border-b-0 md:border-r border-gray-200 py-8 w-full">
                ...
                <div className="mt-4 text-center">
                  <h3 className="font-bold text-gray-900 text-lg mb-2">ХЯЛБАР БУЦААЛТ</h3>
              ...
              <div className="flex flex-col items-center justify-center py-8 w-full">
                ...
                <div className="mt-4 text-center">
                  <h3 className="font-bold text-gray-900 text-lg mb-2">ДЭЛГҮҮРТ ЗОЧЛОХ</h3>
        ...
        <div className="w-full bg-white py-12 mt-16 border-t border-gray-100">
          <div className="max-w-2xl mx-auto px-4">
            ...
            <div className="bg-gray-50 rounded-xl p-6 shadow-sm border border-gray-100 mb-12">
              <h3 className="text-base font-semibold text-gray-800 mb-4 text-center">Сэтгэгдэл үлдээх</h3>
            ...
            <div className="space-y-8">
              <h2 className="text-xl font-bold text-gray-900 mb-6 tracking-tight">Сэтгэгдлүүд</h2>
              {comments.length === 0 ? (
                <div className="text-center text-gray-400 py-8 border rounded-lg">Одоогоор сэтгэгдэл байхгүй байна.</div>
              ) : (
