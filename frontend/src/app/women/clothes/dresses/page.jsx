...
export default function WomenDressesPage() {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:5000/api/products/category/id/ТА_ДААШИНЗ_АНГИЛЛЫН_ID') // ← энд даашинз ангиллын ID-г оруулна уу
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pt-30 py-8">
      <h1 className="text-3xl font-bold mb-8">Эмэгтэй – Даашинз</h1>
