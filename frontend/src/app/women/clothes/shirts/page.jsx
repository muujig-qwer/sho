...
export default function WomenShirtsPage() {
  const [products, setProducts] = useState([])
  const pathname = usePathname()

  useEffect(() => {
    axios
      .get('http://localhost:5000/api/products/category/id/ТА_ЦАМЦ_АНГИЛЛЫН_ID') // ← энд цамц ангиллын ID-г оруулна уу
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pt-30 py-8">
      <h1 className="text-3xl font-bold mb-8">Эмэгтэй – Цамц</h1>
