...
export default function WomenSandalsPage() {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:5000/api/products/category/id/ТА_ЭМЭГТЭЙ_САНДААЛ_АНГИЛЛЫН_ID') // ← энд эмэгтэй сандаалын ангиллын ID-г оруулна уу
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pt-30 py-8">
      <h1 className="text-3xl font-bold mb-8">Эмэгтэй – Сандаал</h1>
